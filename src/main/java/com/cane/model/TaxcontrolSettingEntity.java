 ...
 */
@Entity
@Table(name = "taxcontrolSetting", schema = "invoiceSystem", catalog = "")
public class TaxcontrolSettingEntity {
    private int id;
    ...
    @Basic
    @Column(name = "companyAddress", nullable = true, length = 45)
    ...
    @Basic
    @Column(name = "bankName", nullable = true, length = 45)
    ...
    public boolean equals(Object o) {
        ...
        TaxcontrolSettingEntity that = (TaxcontrolSettingEntity) o;
